...
from guardrail_agent import input_guardrails_agent, output_guardrail_agent
...
FIRE_WORKS_API = os.getenv("FIRE_WORKS_API")
...
async def main():
    ...
    Tafsir_Agent: Agent = Agent(
        ...
        instructions= """You are a Quranic Tafsir agent that provides explanations of Quranic verses
