...
def _fetch_verse_data(
    ...
    try:
        with httpx.AsyncClient(timeout=15.0) as client:
            # Fetch Arabic text
...
def get_complete_verse_data(surah: int, ayah: int) -> Dict[str, Any]:
    """
    ...
    """
    return  _fetch_verse_data(surah, ayah)